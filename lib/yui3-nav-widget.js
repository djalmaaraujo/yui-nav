...
YUI().use(modules, function (Y) {
  ...
  var NavWidget = Y.Base.create("nav-widget", Y.Widget, [], {
    ...
    _loadWidgetCss: function () {
      ...
      if (cssPath) {
        ...
        Get.css('../lib/yui3-nav-widget.css'); // default style
      }
    }
      ...
      },
      {
        ...
        click: function (e) {
          Y.use('anim', function(Y) {
            ...
            a.on('end', function() {
              var destroy = Y.Node.all('.container-fluid');
              destroy.setContent('');
              destroy.setContent('<div class="hero-unit"><h1 class="joke">I told you!</h1><p><a href="" class="btn btn-primary btn-large">Reload &raquo;</a></p></div>');
            });
  ...
  *
  * 
  * Example 3: Markup HTML with a template website
  *
  *
  *
  */
  if (Node.one('#menu')) {
    var navTemplate = new NavWidget({
      srcNode: '#menu',
      dataSource: '#menu',
      cssPath: '../lib/yui3-nav-widget.css'
    });
    navTemplate.render();
  }
  ...
  *
  * 
  * Example 4: Markup HTML with no style
  *
  *
  *
  */
  if (Node.one('#example4')) {
    var navExample4 = new NavWidget({
      srcNode: '#example4',
      dataSource: '#example4',
      cssPath: '../lib/yui3-nav-widget.css'
    });
